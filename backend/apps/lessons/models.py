...
class Lesson(models.Model):
    ...
    # DB uses 'regular_counted' in existing rows; keep default aligned to avoid constraint issues.
    billing_kind = models.CharField(max_length=20, default='regular_counted')
    related_class_id = models.IntegerField(null=True, blank=True)
    makeup_pricing_mode = models.CharField(max_length=20, null=True, blank=True, default=None)
    ...
    absence_pricing_mode = models.CharField(max_length=20, null=True, blank=True, default=None)
    reschedule_mode = models.CharField(max_length=20, null=True, blank=True, default=None)
